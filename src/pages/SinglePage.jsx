...
export default function SinglePage() {
  ...
  // Sync body.menu-open with state and prevent background scroll (your CSS handles overflow)
  useEffect(() => {
    if (menuOpen) {
  ...
  // Close on Escape and focus management for accessibility
  useEffect(() => {
    const onKeyDown = (e) => {
                ...
                {sections.map((section, idx) => (
                  <li key={section}>
                    <ScrollLink
                      ...
                      activeClass="active"
                      // put ref on first link for keyboard focus when opening
            ...
            {[
              {
                ...
                desc: 'An interactive photo gallery connected to Instagram with month-wise filtering, animations, and responsive design. Includes an online store with cart and we can buy photo frame in that website.',
                image: project1Img,
...
//                 desc: 'An interactive photo gallery connected to Instagram with month-wise filtering, animations, and responsive design. Includes an online store with cart and we can buy photo frame in that website.',
//                 image: project1Img,
//                 link: 'https://github.com/kishore1620/vijaypranavwildlifephotographywebsite', // 🦁 replace with actual link
//               },
//               {
//                 title: 'Weather App',
//                 desc: 'A sleek, responsive app fetching real-time weather data using a public API. Displays current conditions and 5-day forecasts with animated visuals.',
//                 image: project2Img,
//                 link: 'https://weatherappbykishore.netlify.app/', // 🌤️ replace with actual link
//               },
//               {
//                 title: 'Gym Nation Workout Tracker',
//                 desc: 'A fitness app to log workouts and calculate calories burned daily using Bootstrap and JavaScript.',
//                 image: project3Img,
//                 link: 'https://github.com/kishore1620/gymnationcoimbatorewebsite', // 💪 replace with actual link
//               },
//               {
//                 title: 'React Portfolio',
//                 desc: 'Personal animated portfolio using React and Framer Motion with dark theme and smooth scroll navigation.',
//                 image: project4Img,
//                 link: 'https://kishoreportfoliowebsite.netlify.app/', // 💻 replace with actual link
//               },
//             ].map((project, i) => (
//               <a
//                 href={project.link}
